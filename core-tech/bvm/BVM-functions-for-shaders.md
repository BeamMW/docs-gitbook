...
* [get_HdrInfo](get_HdrInfo)
* [get_HdrFull](get_HdrFull)
* [get_RulesCfg](get_RulesCfg)
* [Write](Write)
...
* [HashCreateSha256](HashCreateSha256)
* [HashCreateBlake2b](HashCreateBlake2b)
* [HashCreateKeccak](HashCreateKeccak)
* [HashWrite](HashWrite)
* [HashGetValue](HashGetValue)
* [HashFree](HashFree)
* [HashClone](HashClone)
* [VerifyBeamHashIII](VerifyBeamHashIII)

## secp256k1 (elliptic curve cryptography) functions:
* [Secp_Scalar_alloc](Secp_Scalar_alloc)
* [Secp_Scalar_free](Secp_Scalar_free)
* [Secp_Scalar_import](Secp_Scalar_import)
* [Secp_Scalar_export](Secp_Scalar_export)
* [Secp_Scalar_neg](Secp_Scalar_neg)
* [Secp_Scalar_add](Secp_Scalar_add)
* [Secp_Scalar_mul](Secp_Scalar_mul)
* [Secp_Scalar_inv](Secp_Scalar_inv)
* [Secp_Scalar_set](Secp_Scalar_set)
* [Secp_Point_alloc](Secp_Point_alloc)
* [Secp_Point_free](Secp_Point_free)
* [Secp_Point_Import](Secp_Point_Import)
* [Secp_Point_Export](Secp_Point_Export)
* [Secp_Point_neg](Secp_Point_neg)
* [Secp_Point_add](Secp_Point_add)
* [Secp_Point_mul](Secp_Point_mul)
* [Secp_Point_IsZero](Secp_Point_IsZero)
* [Secp_Point_mul_G](Secp_Point_mul_G)
* [Secp_Point_mul_J](Secp_Point_mul_J)
* [Secp_Point_mul_H](Secp_Point_mul_H)
...
## Cross-contract
* [CallFar](CallFar)
* [get_CallDepth](get_CallDepth)
* [get_CallerCid](get_CallerCid)
* [RefAdd](RefAdd)
...
## Variable management
* [Vars_Enum](Vars_Enum)
* [Vars_MoveNext](Vars_MoveNext)
* [Vars_Close](Vars_Close)
* [VarGetProof](VarGetProof)
## Log management
* [Logs_Enum](Logs_Enum)
* [Logs_MoveNext](Logs_MoveNext)
* [Logs_Close](Logs_Close)
* [LogGetProof](LogGetProof)
## Key management
* [DerivePk](DerivePk)
## Application JSON response
* [DocAddGroup](DocAddGroup)
* [DocCloseGroup](DocCloseGroup)
* [DocAddText](DocAddText)
* [DocAddNum32](DocAddNum32)
* [DocAddNum64](DocAddNum64)
* [DocAddArray](DocAddArray)
* [DocCloseArray](DocCloseArray)
* [DocAddBlob](DocAddBlob)
# Application parameters
* [DocGetText](DocGetText)
* [DocGetNum32](DocGetNum32)
* [DocGetNum64](DocGetNum64)
* [DocGetBlob](DocGetBlob)
## Transaction management
* [SelectContext](SelectContext)
* [GenerateKernel](GenerateKernel)
* [GenerateKernelAdvanced](GenerateKernelAdvanced)
* [GenerateRandom](GenerateRandom)
## Nonce management
* [SlotInit](SlotInit)
* [get_SlotImage](get_SlotImage)
* [get_SlotImageEx](get_SlotImageEx)
* [get_BlindSk](get_BlindSk)
* [get_Pk](get_Pk)
* [get_PkEx](get_PkEx)
## Communication
* [Comm_Listen](Comm_Listen)
* [Comm_Send](Comm_Send)
* [Comm_Read](Comm_Read)
* [Comm_WaitMsg](Comm_WaitMsg)
