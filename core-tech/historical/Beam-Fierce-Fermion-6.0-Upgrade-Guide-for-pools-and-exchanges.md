> **Historical** — This document was the upgrade guide for the Beam Fierce Fermion 6.0 hard fork (block 1,280,000, June 2021), which introduced smart contracts, Confidential Assets in the wallet API, and new address types. It is preserved for historical reference.
