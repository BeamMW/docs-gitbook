> **Historical Document** — BeamX was an experimental confidential DeFi platform on Beam's public testnet. This guide is preserved for historical reference only.
