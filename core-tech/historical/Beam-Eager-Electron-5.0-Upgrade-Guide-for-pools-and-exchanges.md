> **Historical** — This document was the upgrade guide for the Beam Eager Electron 5.0 hard fork (block 777,777, June 2020), which introduced Beam Hash III mining and initial Confidential Assets support. It is preserved for historical reference.
