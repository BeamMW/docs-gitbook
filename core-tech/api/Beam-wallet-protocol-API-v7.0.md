...
- [tx_status](#tx_status) and [tx_list](#tx_list) return `appid` and `appname` for transactions initated by dapps.
- [tx_status](#tx_status) and [tx_list](#tx_list) return currency `rates` at the moment of transaction
- [ev_connection_changed](#ev_connection_changed) event added to [ev_subunsub](#ev_subunsub) method
- `available_regular`, `available_regular_str`, `available_mp`, `available_mp_str`, `receiving_regular`, `receiving_regular_str`, `receiving_mp`, `receiving_mp_str`, `sending_regular`, `sending_regular_str`, `sending_mp`, `sending_mp_str`, `maturing_regular`, `maturing_regular_str`, `maturing_mp`, `maturing_mp_str`, `change`, `change_str`, `locked`, `locked_str` fields added for each asset in [wallet_status](#wallet_status) method
- [tx_status](#tx_status) and [tx_list](#tx_list) added field `address_type` for push transactions
...
- [ev_connection_changed](#ev_connection_changed)

### Changed events

- [ev_txs_changed](#ev_txs_changed) returns `rates` array by default for all transactions
